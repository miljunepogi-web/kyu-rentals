-- ============================================================================
-- KYU RENTALS - PAYMONGO WEBHOOK BALANCE DUE FIX
-- Date: 2026-07-27
-- Purpose:
--   Preserve balance_amount during reservation deposit confirmation. The booking
--   balance already represents the post-deposit amount due on delivery.
-- ============================================================================
