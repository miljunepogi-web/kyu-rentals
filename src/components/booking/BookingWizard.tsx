        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {step === 1 && (
            <div className="rounded-2xl sm:rounded-3xl border bg-card p-4 sm:p-6 md:p-8 shadow-xs space-y-5 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      disabled={isBusy}
                      className="mt-1.5 flex h-11 sm:h-12 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring truncate"
                    >
              ...
              <Button
                ...
                disabled={isBusy}
                className="w-full h-11 sm:h-12 font-semibold text-sm sm:text-base mt-4"
              >
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-xl border p-4">
                  ...
                  <div className="flex items-center gap-3 self-end sm:self-auto">
                    <Button
                      ...
                      className="h-10 w-10 text-base font-bold p-0"
                    >
                      -
                    </Button>
                ...
                <div className="flex items-center justify-between gap-3 rounded-xl border p-4">
                  ...
                  <input
                    ...
                    disabled={isBusy}
                    className="h-5 w-5 shrink-0 rounded border-gray-300 text-primary focus:ring-primary cursor-pointer"
                  />
                </div>
              </div>

              <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4">
                <Button variant="outline" onClick={() => setStep(1)} disabled={isBusy} className="w-full sm:w-auto h-11 sm:h-12">
                  <ArrowLeft className="mr-2 h-4 w-4" /> Back
                </Button>
                <Button onClick={handleNextFromStep2} disabled={isBusy} className="w-full sm:flex-1 h-11 sm:h-12 font-semibold text-sm sm:text-base">
          ...
          {step === 3 && (
            <div className="rounded-2xl sm:rounded-3xl border bg-card p-4 sm:p-6 md:p-8 shadow-xs space-y-5 sm:space-y-6">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4">
                <Button variant="outline" onClick={() => setStep(2)} disabled={isBusy} className="w-full sm:w-auto h-11 sm:h-12">
                  <ArrowLeft className="mr-2 h-4 w-4" /> Back
                </Button>
                <Button onClick={handleNextFromStep3} disabled={isBusy} className="w-full sm:flex-1 h-11 sm:h-12 font-semibold text-sm sm:text-base">
          ...
          {step === 4 && (
            <form onSubmit={handleProceedToPayment} className="rounded-2xl sm:rounded-3xl border bg-card p-4 sm:p-6 md:p-8 shadow-xs space-y-5 sm:space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 rounded-xl bg-secondary/40 p-3.5 sm:p-4 border text-xs">
                  <input
                    ...
                    disabled={isBusy}
                    className="mt-0.5 h-5 w-5 shrink-0 rounded border-gray-300 text-primary focus:ring-primary cursor-pointer"
                  />
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3 pt-4">
                <Button type="button" variant="outline" onClick={() => setStep(3)} className="w-full sm:w-auto h-11 sm:h-12" disabled={isBusy}>
                  <ArrowLeft className="mr-2 h-4 w-4" /> Back
                </Button>
                <Button type="submit" className="w-full sm:flex-1 h-12 font-bold text-sm sm:text-base" disabled={isBusy}>
                  {isSubmitting ? (
                    "Reserving Inventory..."
                  ) : (
                    <>
